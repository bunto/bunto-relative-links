RSpec.describe BuntoRelativeLinks::Generator do
  let(:overrides) { {} }
  ...
  context "detecting markdown" do
    ...
    it "knows the markdown converter" do
      expect(subject.send(:markdown_converter)).to be_a(Bunto::Converters::Markdown)
    end
  end
  ...
  context "generating" do
    ...
    context "images" do
      it "handles images" do
        expect(subdir_page.content).to include("![image](/bunto-logo.png)")
      end
    end
  end
end
